#'  A function to calculate number of missing values in a data set
#'
#'  Given a data frame `data` and a
...
#' @examples
#' library(datateachr)
#' count_all_missing_by_group(datateachr::flow_sample, extreme_type)
#'
